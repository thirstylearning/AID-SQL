...
class TrainingSettings:
    ...
    use_self_negatives: bool = DefaultVal(False)
    use_self_easy_negatives: bool = DefaultVal(False)
    use_scores_distillation: bool = DefaultVal(True)

    # My Settings
    start_epoch: int = DefaultVal(0)
    easy_nway: int = DefaultVal(0)
    save_each_n_epoch: int = DefaultVal(1)
    query_str_formatter_type: str = DefaultVal("question") # question, question_sql
    doc_str_formatter_type: str = DefaultVal("sql") # sql, question_sql
